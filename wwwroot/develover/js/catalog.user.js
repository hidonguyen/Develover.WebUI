var user = (function (self) {
    ...
    let initializeIndex = () => {
        $('#dt-users').dataTable({
            ...
            columns: [
                { data: "name", title: "Tên" },
                { data: "initial", title: "Mở đầu" },
                { data: "username", title: "Tên người dùng" },
                { data: "dateOfBirth", title: "Ngày sinh" },
                { data: "phone", title: "Điện thoại" },
                { data: "email", title: "Thư điện tử" },
                { data: "selectedRoles", title: "Chọn vai trò" },
                { data: "selectedBranches", title: "Chọn chi nhánh" },
    ...
    let loadData = () => {
        ...
        $("#Username", context).val(model.username);
        $("#DateOfBirth", context).val(model.dateOfBirth);
        $("#Phone", context).val(model.phone);
        $("#Email", context).val(model.email);
        $("#SelectedRoles", context).val(model.selectedRoles);
        $("#SelectedBranches", context).val(model.selectedBranches);
    ...
    let createModel = () => {
        ...
        model.username = $("input#Username", context).val();
        model.dateOfBirth = $("input#DateOfBirth", context).val();
        model.phone = $("input#Phone", context).val();
        model.email = $("input#Email", context).val();
        model.selectedRoles = $("select#SelectedRoles", context).val();
        model.selectedBranches = $("select#SelectedBranches", context).val();
