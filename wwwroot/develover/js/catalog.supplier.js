var supplier = (function (self) {
    let baseUrl = '/supplier';
    let mode = CatalogMode.VIEW;
    let modelId = urlParams.get('id');
    let context = $("#panel-supplier");

    let isModal = false;
    if ($("#modal-supplier").length) {
        context = $("#modal-supplier");
        isModal = true;
    }
    ...
    let initializeIndex = () => {
        $('#dt-suppliers').dataTable({
            ...
            columnDefs: [
                {
                    targets: 0,
                    render: supplierDrillDownFormatter
                },
                {
                    targets: -1,
                    width: 65,
    ...
    let loadData = () => {
        ...
        $("#TaxCode", context).val(model.taxCode);
    ...
    let createModel = () => {
        ...
        model.taxCode = $("input#TaxCode", context).val();
