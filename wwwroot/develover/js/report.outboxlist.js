function OutboxList(options, model) {
    ...
    this.onFilterChange = (e) => {
        ...
        let dataUrl = model.dataUrl.replace("{filterFromDate}", $FilterForm.find("#FilterFromDate").prop("checked"))
            ...
            .replace("{publishedPlaceId}", $FilterForm.find("#PublishedPlaceId").val())
            .replace("{deliverId}", $FilterForm.find("#DeliverId").val())
    ...
    $("#report-quick-filter").on("change", (e) => {
        ...
        $("#PublishedPlaceId", $FilterForm).val();
        $("#DeliverId", $FilterForm).val();
